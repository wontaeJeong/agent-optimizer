...
# 실제 기본 URL과 AGENT_OPT_MODEL_API_KEY를 셸에 설정한 뒤:
...
`AGENT_OPT_MODEL_BASE_URL` 뒤에 `/chat/completions`를 붙여 사용합니다. 전체 completion URL을
설정하거나 기존 `AGENT_OPT_MODEL_ENDPOINT`를 사용하면 오류가 납니다.
