...
**완료된 선행 검증:** `10baa46`의 native Ubuntu x86_64 재실행에서 PR 코어 Python 3.11/3.12·wheel과
수동 공식 setup/offline/smoke·provider config 검사가 통과했다. 첫 FROM 참조 실패, Mac ARM64 결과,
